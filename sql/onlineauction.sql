...
CREATE TABLE `auction_goods`  (
  ...
  `category_id` bigint NOT NULL COMMENT '商品类目ID（关联auction_category.id）',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '拍卖商品表' ROW_FORMAT = DYNAMIC;
